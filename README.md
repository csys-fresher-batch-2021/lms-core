...
```sql
insert into LMS_EMPLOYEES_LEAVE_DET (LEAVE_ID,EMPLOYEE_CODE,MANAGER_CODE,LEAVE_TYPE,LEAVE_REASON,LEAVE_START_DATE,LEAVE_END_DATE,TOTAL_LEAVE,LEAVE_BALANCE,STATUS)
                                   values (101,'E1002','E1006','CASUAL_LEAVE','FUNCTION','07-02-2021','07-02-2021',21,20,'APLLIED');
```
